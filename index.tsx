...
const INITIAL_SDE_DATA = [
  ...
  { serial: 2, nameBn: "জনাব ওয়ালিউর রহমান", nameEn: "Waliur Rahman", designationBn: "উপ-বিভাগীয় প্রকৌশলী", designationEn: "Sub Divisional Engineer", dob: "16-11-1987", id: "1-01893", prl: "16-11-2046" },
  ...
  { serial: 11, nameBn: "জনাব তানভীর হাছান ভূইয়া", nameEn: "Tanvir Hasan Bhuiyan", designationBn: "নির্বাহী প্রকৌশলী (ভারপ্রাপ্ত)", designationEn: "Executive Engineer (Acting)", dob: "27-12-1987", id: "1-01987", prl: "27-12-2046" },
  ...
  { serial: 19, nameBn: "জনাব রাবেয়া জামান", nameEn: "Rabeya Zaman", designationBn: "উপ-পরিচালক (ভারপ্রাপ্ত)", designationEn: "Deputy Director (Acting)", dob: "18-06-1985", id: "1-02000", prl: "18-06-2044" },
  ...
  { serial: 24, nameBn: "জনাব মোঃ রিয়াজুল হক", nameEn: "Md. Riazul Haque", designationBn: "নির্বাহী প্রকৌশলী (ভারপ্রাপ্ত)", designationEn: "Executive Engineer (Acting)", dob: "01-01-1987", id: "1-02006", prl: "01-01-2046" },
  ...
  { serial: 33, nameBn: "জনাব মোঃ তারেক ছেফাতী", nameEn: "Md. Tareq Shefati", designationBn: "উপবিভাগীয় প্রকৌশলী (ভারঃ)", designationEn: "Sub Divisional Engineer (Acting)", dob: "14-12-1985", id: "1-02016", prl: "14-12-2044" },
  { serial: 34, nameBn: "জনাব গিয়াস ইবনে আলম", nameEn: "Gias Ibne Alam", designationBn: "নির্বাহী প্রকৌশলী (ভারপ্রাপ্ত)", designationEn: "Executive Engineer (Acting)", dob: "15-08-1988", id: "1-02017", prl: "15-08-2047" },
  ...
  { serial: 41, nameBn: "জনাব নেহলিন নূরাইয়্যাহ নিকি", nameEn: "Nehlin Nuraiyah Niki", designationBn: "নির্বাহী প্রকৌশলী (ভারপ্রাপ্ত)", designationEn: "Executive Engineer (Acting)", dob: "21-11-1987", id: "1-02026", prl: "21-11-2046" },
  { serial: 42, nameBn: "জনাব নওয়াজ আহমেদ khan", nameEn: "Nawaz Ahmed Khan", designationBn: "নির্বাহী প্রকৌশলী (ভারপ্রাপ্ত)", designationEn: "Executive Engineer (Acting)", dob: "10-11-1985", id: "1-02027", prl: "10-11-2044" },
  ...
  { serial: 49, nameBn: "জনাব মোঃ মনোয়ার জাহিদ khan", nameEn: "Md. Monowar Zahid Khan", designationBn: "উপ-বিভাগীয় প্রকৌশলী", designationEn: "Sub Divisional Engineer", dob: "01-11-1987", id: "1-02039", prl: "01-11-2046" },
  ...
  { serial: 54, nameBn: "জনাব জোবায়ের রহমান", nameEn: "Jobayer Rahman", designationBn: "নির্বাহী প্রকৌশলী (ভারপ্রাপ্ত)", designationEn: "Executive Engineer (Acting)", dob: "07-11-1986", id: "1-01904", prl: "07-11-2045" },
  { serial: 55, nameBn: "জনাব রুহানা রাঈয়ান প্রমী", nameEn: "Ruhana Raiyan Promi", designationBn: "উপ-পরিচালক (ভারপ্রাপ্ত)", designationEn: "Deputy Director (Acting)", dob: "16-10-1988", id: "1-01905", prl: "16-10-2047" },
  { serial: 56, nameBn: "জনাব মোঃ রোকুনুজ্জামান khan", nameEn: "Md. Rokonuzzaman Khan", designationBn: "উপ-ব্যবস্থাপক (নির্বাহী প্রকৌশলী ভারপ্রাপ্ত)", designationEn: "Deputy Manager (Acting)", dob: "06-12-1985", id: "1-01906", prl: "06-12-2044" },
  ...
  { serial: 63, nameBn: "জনাব ওয়াহিদুল ইসলাম", nameEn: "Wahidul Islam", designationBn: "নির্বাহী প্রকৌশলী (ভারপ্রাপ্ত)", designationEn: "Executive Engineer (Acting)", dob: "01-03-1989", id: "1-01914", prl: "01-03-2048" },
  ...
  { serial: 70, nameBn: "জনাব মোঃ জাকারিয়া সরকার", nameEn: "Md. Zakaria Sarkar", designationBn: "নির্বাহী প্রকৌশলী (ভারঃ)", designationEn: "Executive Engineer (Acting)", dob: "27-09-1984", id: "1-01921", prl: "27-09-2043" },
  ...
  { serial: 74, nameBn: "জনাব মোঃ আতিয়ার রহমান", nameEn: "Md. Atiar Rahman", designationBn: "নির্বাহী প্রকৌশলী, (ভারঃ)", designationEn: "Executive Engineer (Acting)", dob: "25-11-1982", id: "1-01925", prl: "25-11-2041" },
  ...
  { serial: 82, nameBn: "জনাব মোঃ ফয়сал আহমেদ", nameEn: "Md. Foysal Ahmed", designationBn: "নির্বাহী প্রকৌঃ (ভারপ্রাপ্ত)", designationEn: "Executive Engineer (Acting)", dob: "25-10-1985", id: "1-02048", prl: "25-10-2044" },
  ...
  { serial: 84, nameBn: "জনাব কায়েস মোঃ আবু রেজা", nameEn: "Kayes Md. Abu Reza", designationBn: "নির্বাহী প্রকৌশলী (ভারপ্রাপ্ত)", designationEn: "Executive Engineer (Acting)", dob: "25-06-1988", id: "1-02050", prl: "25-06-2047" },
  ...
  { serial: 89, nameBn: "জনাব ওয়াদুদ আলী", nameEn: "Wadud Ali", designationBn: "নির্বাহী প্রকৌশলী (ভারঃ)", designationEn: "Executive Engineer (Acting)", dob: "14-04-1986", id: "1-02056", prl: "14-04-2045" },
  ...
  { serial: 91, nameBn: "জনাব অপর্ণা বড়ুয়া", nameEn: "Aparna Barua", designationBn: "নির্বাহী প্রকৌশলী (ভারপ্রাপ্ত)", designationEn: "Executive Engineer (Acting)", dob: "07-01-1987", id: "1-02062", prl: "07-01-2046" },
  ...
  { serial: 96, nameBn: "জনাব সানজানা হক", nameEn: "Sanjana Haque", designationBn: "উপ-বিভাগীয় প্রকৌশলী", designationEn: "Sub Divisional Engineer", dob: "04-02-1990", id: "1-02071", prl: "04-02-2049" },
  ...
  { serial: 99, nameBn: "জনাব মাহবুবুর রহমান", nameEn: "Mahbubur Rahman", designationBn: "উপ-বিভাগীয় প্রকৌশলী", designationEn: "Sub Divisional Engineer", dob: "07-09-1989", id: "1-02076", prl: "07-09-2048" },
  ...
  { serial: 275, nameBn: "জনাব মোঃ মিনহাজুল হক", nameEn: "Md. Minhajul Haque", designationBn: "উপ-বিভাগীয় প্রকৌশলী", designationEn: "Sub Divisional Engineer", dob: "08-03-1992", id: "1-02334", prl: "08-03-2051", isCreator: true, creatorId: "102333" },
  
  // Fillers to simulate highly detailed record sequence up to 327
  { serial: 318, nameBn: "জনাব মোঃ রবিন খান", nameEn: "Md. Robin Khan", designationBn: "উপ-বিভাগীয় প্রকৌশলী", designationEn: "Sub Divisional Engineer", dob: "21-09-1989", id: "1-02401", prl: "21-09-2048" },
  { serial: 319, nameBn: "জনাব রোজালিনা রফিক", nameEn: "Rosalina Rafiq", designationBn: "উপ-বিভাগীয় প্রকৌশলী", designationEn: "Sub Divisional Engineer", dob: "08-02-1993", id: "1-02402", prl: "08-02-2052" },
  { serial: 320, nameBn: "জনাব সৈকত সাহা", nameEn: "Saikat Saha", designationBn: "উপ-বিভাগীয় প্রকৌশলী", designationEn: "Sub Divisional Engineer", dob: "01-01-1993", id: "1-02406", prl: "01-01-2052" },
  { serial: 321, nameBn: "জনাব মোঃ নাজিম উদ্দিন", nameEn: "Md. Nazim Uddin", designationBn: "উপ-বিভাগীয় প্রকৌশলী", designationEn: "Sub Divisional Engineer", dob: "01-01-1992", id: "1-02407", prl: "01-01-2051" },
  { serial: 322, nameBn: "জনাব মোহাম্মদ আসাদুল ইসলাম", nameEn: "Mohammad Asadul Islam", designationBn: "উপ-বিভাগীয় প্রকৌশলী", designationEn: "Sub Divisional Engineer", dob: "26-02-1994", id: "1-02408", prl: "26-02-2053" },
  { serial: 323, nameBn: "জনাব সমীক পোদ্দার", nameEn: "Samik Poddar", designationBn: "উপ-বিভাগীয় প্রকৌশলী", designationEn: "Sub Divisional Engineer", dob: "07-06-1989", id: "1-02409", prl: "07-06-2048" },
  { serial: 324, nameBn: "জনাব মোঃ আব্দুল জলিল", nameEn: "Md. Abdul Jalil", designationBn: "উপ-বিভাগীয় প্রকৌশলী", designationEn: "Sub Divisional Engineer", dob: "10-12-1988", id: "1-02410", prl: "10-12-2047" },
  { serial: 325, nameBn: "জনাব এম. এম. ফাতিন হাসনাত", nameEn: "M. M. Fatin Hasnat", designationBn: "উপ-বিভাগীয় প্রকৌশলী", designationEn: "Sub Divisional Engineer", dob: "06-08-1993", id: "1-02412", prl: "06-08-2052" },
  { serial: 326, nameBn: "জনাব মোঃ শরীফুল ইসলাম", nameEn: "Md. Shariful Islam", designationBn: "উপ-বিভাগীয় প্রকৌশলী", designationEn: "Sub Divisional Engineer", dob: "21-12-1991", id: "1-02413", prl: "21-12-2050" },
  { serial: 327, nameBn: "জনাব মোঃ ইমরান হোসেন তালুকদার", nameEn: "Md. Imran Hossain Talukdar", designationBn: "উপ-বিভাগীয় প্রকৌশলী", designationEn: "Sub Divisional Engineer", dob: "20-08-1995", id: "1-02414", prl: "20-08-2054" }
];
...
const populateDatabase = () => {
  ...
  for (let s = 1; s <= 327; s++) {
    if (existingMap.has(s)) {
      ...
      const isExEn = s < 100;
      const designationBn = isExEn ? "নির্বাহী প্রকৌশলী (ভারপ্রাপ্ত)" : "উপ-বিভাগীয় প্রকৌশলী";
...
export default function App() {
  ...
  const [formData, setFormData] = useState({
    ...
    nameBn: "",
    nameEn: "",
    designationBn: "উপ-বিভাগীয় প্রকৌশলী",
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-lg font-bold tracking-tight text-white flex items-center gap-2">
                {language === "bn" ? "উপ-বিভাগীয় প্রকৌশলী জ্যেষ্ঠতা তালিকা" : "SDE Seniority Registry Tracker"}
      ...
      <main className="flex-1 max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-6 space-y-6">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <div className="bg-slate-900 border border-slate-800 p-4 rounded-xl flex items-center justify-between">
            <div>
              <span className="text-xs text-slate-400 block font-medium">
                {language === "bn" ? "উপ-বিভাগীয় প্রকৌশলী" : "Sub Divisional SDEs"}
              </span>
        ...
        <div className="bg-slate-900 border border-slate-800 rounded-2xl p-4 sm:p-5 space-y-4 shadow-xl">
          <div className="flex flex-col md:flex-row gap-4 items-center justify-between">
            ...
            <div className="relative w-full md:w-96">
              ...
              <input
                type="text"
                placeholder={language === "bn" ? "নাম, পরিচিতি নং বা ক্রমিক দিয়ে খুঁজুন..." : "Search SDE by Name, ID, or Serial..."}
                value={searchQuery}
            ...
            <div className="flex flex-wrap items-center gap-3 w-full md:w-auto">
              ...
              <div className="flex-1 sm:flex-initial">
                ...
                >
                  ...
                  <option value="Sub Divisional Engineer">{language === "bn" ? "উপ-বিভাগীয় প্রকৌশলী" : "Sub Divisional Engineer"}</option>
              ...
              <div className="flex-1 sm:flex-initial">
                ...
                <select
                  ...
                  className="w-full sm:w-48 bg-slate-950 border border-slate-800 text-slate-200 px-3 py-2 rounded-xl text-xs focus:outline-none focus:ring-2 focus:ring-emerald-500"
                >
                  <option value="All">{language === "bn" ? "সকল অবসর সময়কাল" : "All Retirement Timeline"}</option>
        ...
        <div className="bg-slate-900 border border-slate-800 rounded-2xl overflow-hidden shadow-xl">
                ...
                {paginatedSdes.length > 0 ? (
                  ...
                  <tr>
                    <td colSpan="7" className="py-12 text-center text-slate-500 font-semibold">
                      {language === "bn" ? "কোন তথ্য পাওয়া যায়নি!" : "No SDE records match search filters."}
                    </td>
                  </tr>
                )}
              </tbody>
          ...
          <div className="bg-slate-950 border-t border-slate-800 px-4 py-3 flex items-center justify-between flex-col sm:flex-row gap-4">
            ...
            <div className="flex items-center gap-2">
              <span className="text-xs text-slate-400">{language === "bn" ? "প্রতি পৃষ্ঠায় রেকর্ড:" : "Rows per page:"}</span>
              <select
            ...
            <div className="p-6 space-y-5">
              ...
              {(selectedSde.isCreator || selectedSde.serial === 275) && (
                <div className="bg-teal-950/30 border border-teal-500/25 p-3.5 rounded-xl text-xs text-teal-300">
                  ...
                  <p>
                    {language === "bn" 
                      ? "এই তালিকাটি মোহাঃ মিনহাজুল হক, উপ-বিভাগীয় প্রকৌশলী (পরিচিতি নং ১-০২৩৩৪) দ্বারা সংকলিত এবং ডিজিটালাইজ করা হয়েছে।"
          ...
          <div className="bg-slate-900 border border-slate-800 rounded-2xl w-full max-w-lg overflow-hidden shadow-2xl">
            <div className="px-6 py-4 bg-slate-950 border-b border-slate-800 flex justify-between items-center">
              <h3 className="font-bold text-sm uppercase tracking-wider text-slate-300">
                {modalMode === "add" 
                  ? (language === "bn" ? "নতুন উপ-বিভাগীয় প্রকৌশলী যুক্ত করুন" : "Add New SDE Record")
            ...
            <form onSubmit={handleSaveRecord} className="p-6 space-y-4 text-xs">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) => {
                      ...
                      const enValue = value === "উপ-বিভাগীয় প্রকৌশলী" ? "Sub Divisional Engineer" : "Executive Engineer (Acting)";
                      setFormData({ ...formData, designationBn: value, designationEn: enValue });
                    }}
                    className="w-full bg-slate-950 border border-slate-800 text-slate-200 p-2.5 rounded-xl text-xs focus:ring-emerald-500"
                  >
                    <option value="উপ-বিভাগীয় প্রকৌশলী">উপ-বিভাগীয় প্রকৌশলী</option>
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) => {
                      const value = e.target.value;
                      const bnValue = value === "Sub Divisional Engineer" ? "উপ-বিভাগীয় প্রকৌশলী" : "নির্বাহী প্রকৌশলী (ভারপ্রাপ্ত)";
              ...
              <div className="flex justify-end gap-2 pt-4 border-t border-slate-800">
                <button
                  type="button"
                  onClick={() => setShowAddEditModal(false)}
                  className="px-4 py-2 bg-slate-800 text-slate-300 rounded-xl transition hover:bg-slate-705"
                >
        ...
        <div className="fixed inset-0 z-50 bg-slate-950/80 backdrop-blur-sm flex items-center justify-center p-4">
          <div className="bg-slate-900 border border-slate-850 rounded-2xl w-full max-w-sm p-5 space-y-4">
            ...
            <div className="flex gap-2 justify-end">
              ...
              >
                {language === "bn" ? "না, ফিরিয়ে নিন" : "Cancel"}
              </button>
              <button
